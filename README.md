...
convert to jpg format with fmt2jpg(). Also, I was not able to change any of the camera's 'sensor' settings like brightness, contrast,
or saturation except for hmirror(), which seems to be required for proper operation. If anyone knows why the framesize descriptors
aren't accurate, or how to implement the rest of the camera's 'sensor' and PIXFORMAT_JPEG settings, I'd appreciate your advice.
